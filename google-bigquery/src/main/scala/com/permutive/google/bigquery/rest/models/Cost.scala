...
object Cost {
  ...
  implicit val commutativeGroup: CommutativeGroup[Cost] = new CommutativeGroup[Cost] {
    ...
    override def combine(x: Cost, y: Cost) =
      new Cost(BigDecimal(x.dollars.bigDecimal.add(y.dollars.bigDecimal, MathContext.UNLIMITED))) {}
