...
trait BigQuerySelectJob[F[_]] {
  ...
  def getAllSelectQueryJobResults(
    ...
    getAllSelectQueryJobResults(
      jobId,
      None,
      None,
      PaginationSettings.default.withMaxResultsPerPage(maxResultsPerPage)
    )
    ...
    new BigQuerySelectJob[F] {
      ...
      override def createRunSelectQuery(
        ...
        for {
          ...
          res <- getAllSelectQueryJobResults(
            job.id,
            location,
            None,
            paginationSettings
      ...
      override def getAllSelectQueryJobResults(
        ...
        val fetch: Option[PageToken] => F[(CompleteSelectJob, Option[PageToken])] =
          getSelectJobResults(
            ...
            location,
            _,
            paginationSettings.maxResultsPerPage
      ...
      private def raiseIfNotSelectResults(
        ...
        results match {
          ...
          case _: IncompleteJob =>
            InvalidResultForSelectResultsException(
              "IncompleteJob",
              jobId
            ).raiseError
